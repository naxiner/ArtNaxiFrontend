...
export class ImageGeneratorService {
  ...
  getPopularPublicImages(pageNumber: number, pageSize: number): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/popular/public?pageNumber=${pageNumber}&pageSize=${pageSize}`)
  }
